...
export const passResult = {
  ...
  chemical: [
    { element: 'C', actual: '0.018', min: '', max: '0.030', requirement: '≤0.030', status: 'ok' },
    { element: 'Si', actual: '0.42', min: '', max: '0.75', requirement: '≤0.75', status: 'ok' },
    { element: 'Mn', actual: '1.35', min: '', max: '2.00', requirement: '≤2.00', status: 'ok' },
    { element: 'P', actual: '0.025', min: '', max: '0.045', requirement: '≤0.045', status: 'ok' },
    { element: 'S', actual: '0.008', min: '', max: '0.030', requirement: '≤0.030', status: 'ok' },
    { element: 'Cr', actual: '16.8', min: '16.0', max: '18.0', requirement: '16.0–18.0', status: 'ok' },
    { element: 'Ni', actual: '10.2', min: '10.0', max: '14.0', requirement: '10.0–14.0', status: 'ok' },
    { element: 'Mo', actual: '2.05', min: '2.0', max: '3.0', requirement: '2.0–3.0', status: 'ok' },
  ],
  mechanical: [
...
export const failResult = {
  ...
  chemical: [
    { element: 'C', actual: '0.022', min: '', max: '0.030', requirement: '≤0.030', status: 'ok' },
    { element: 'Si', actual: '0.38', min: '', max: '0.75', requirement: '≤0.75', status: 'ok' },
    { element: 'Mn', actual: '1.42', min: '', max: '2.00', requirement: '≤2.00', status: 'ok' },
    { element: 'P', actual: '0.030', min: '', max: '0.045', requirement: '≤0.045', status: 'ok' },
    { element: 'S', actual: '0.042', min: '', max: '0.030', requirement: '≤0.030', status: 'fail' },
    { element: 'Cr', actual: '16.5', min: '16.0', max: '18.0', requirement: '16.0–18.0', status: 'ok' },
    { element: 'Ni', actual: '10.5', min: '10.0', max: '14.0', requirement: '10.0–14.0', status: 'ok' },
    { element: 'Mo', actual: '2.10', min: '2.0', max: '3.0', requirement: '2.0–3.0', status: 'ok' },
  ],
  mechanical: [
